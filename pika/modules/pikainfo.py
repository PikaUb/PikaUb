...
@loader.tds
class PikaInfoMod(loader.Module):
    """Show userbot info"""
    ...
    strings = {
        ...
        "desc": (
            ...
            ' href="https://github.com/PikaUb/PikaUb">GitHub</a>'
        ),
    }
    ...
    strings_ru = {
        ...
        "desc": (
            "<emoji document_id=5062291541624619917>😀</emoji> <b>PikaUb</b>"
            " Юзербот, основанный на Hikka-Pyro с богатым функционалом."
    ...
    async def Info(self, _: InlineQuery) -> dict:
        ...
        return {
            ...
            **(
            ...
            "thumb": ("https://github.com/PikaUb/PikaUb/raw/main/assets/bot_pfp.png"),
