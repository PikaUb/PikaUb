...
class CoreMod(loader.Module):
    ...
    strings = {
        ...
        "netfoll": (
            ...
            "</b> <i>{}</i>\n{}"
            " <b>Hikka-Pyro:</b> <i>{}</i>\n"
            "<emoji document_id=5188666899860298925>🌒</emoji> <b>Pika:</b> <i>V1.6.1</i>\n<emoji"
            " 🦐"
            " <b>Developers: pika_talks.t.me</b>"
        ),
        ...
        "prefix_collision": (
            "<emoji document_id=5469654973308476699>💣</emoji> <b>Your Dragon and Pika"
    ...
    strings_ru = {
        ...
        "netfoll": (
            ...
            "<emoji document_id=5188666899860298925>🌒</emoji> <b>Pika:</b> <i>V1.6.1</i>\n<emoji"
            "🦐"
            " <b>Разработчики: pika_talks.t.me</b>"
        ),
