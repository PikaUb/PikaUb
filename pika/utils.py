...
def get_platform_emoji(client: typing.Optional[CustomTelegramClient] = None) -> str:
    ...
    """
    BASE = ("<emoji document_id=5224301818313450421>🧑‍💼</emoji> <b>PikaUserbot</b>",)
...
def get_commit_url() -> str:
    ...
    try:
        hash_ = get_git_hash()
        return f'<a href="https://github.com/PikaUb/PikaUb/commit/{hash_}">#{hash_[:7]}</a>'
    except Exception:
        return "Unknown"
...
def get_git_info() -> typing.Tuple[str, str]:
    ...
    return (
        hash_,
        f"https://github.com/PikaUb/PikaUb/commit/{hash_}" if hash_ else "",
    )
